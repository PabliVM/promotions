...
var COLS   = [8, 22, 36, 50, 64, 78, 92];
FILAS.forEach(t => COLS.forEach(l => SNAP_SLOTS.push([t, l])));
var FILAS_EXT = [83, 69, 55, 42, 29, 15];
var COLS_EXT  = [15, 36, 50, 64, 85];
FILAS_EXT.forEach(t => COLS_EXT.forEach(l => SNAP_SLOTS.push([t, l])));
var ROMBO_PORTERO = [[84,50],[90,33],[90,67],[96,50]];
ROMBO_PORTERO.forEach(s=>SNAP_SLOTS.push(s));
var POS_DEF = SNAP_SLOTS;
var LINEAS_FORMACION = FILAS.map(t => [t, COLS]);
...
var JERARQUIA = ['CADETE A','JUVENIL C','JUVENIL B','JUVENIL A','RMC','CASTILLA'];
var EQUIPO_SUPERIOR = {
  'CADETE A':  'JUVENIL C',
  'JUVENIL C': 'JUVENIL B',
  'JUVENIL B': 'JUVENIL A',
...
var LS_KEY     = 'rm_cantera_v2';
var LS_SEASONS = 'rm_cantera_seasons';
