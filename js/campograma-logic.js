...
<script src="js/campograma-firebase-init.js"></script>
  ...
  <div id="reg-box">
    ...
    <div id="reg-body">
      ...
      <div id="reg-filters">
        ...
        <select id="reg-eq-filter" onchange="renderReg()">
...
<div id="reset-modal-overlay" onclick="cerrarResetModal(event)">
  <div id="reset-modal-box">
    <div id="reset-modal-hdr">
      ...
      <button onclick="cerrarResetModal()" style="background:none;border:none;cursor:pointer;color:rgba(255,255,255,.5);font-size:20px;line-height:1;padding:4px;">×</button>
    </div>
...
<header id="app-header">
  ...
  <div id="hdr-identity">
    ...
    <div id="hdr-titles">
      <span id="hdr-club">Campograma</span>
  ...
  <div id="hdr-right">
    ...
    <div id="save-area">
      <button id="save-btn" onclick="guardarManual()" title="Guardar">
...
<div id="sub-header">
  ...
  <!-- Leyenda equipos -->
  <div id="sub-leyenda">
    <span class="sub-ley"><span class="sub-ley-dot" style="background:#003087"></span>CAS</span>
    <span class="sub-ley"><span class="sub-ley-dot" style="background:#7030A0"></span>RMC</span>
    <span class="sub-ley"><span class="sub-ley-dot" style="background:#FFC000"></span>JA</span>
    <span class="sub-ley"><span class="sub-ley-dot" style="background:#275317"></span>JB</span>
    <span class="sub-ley"><span class="sub-ley-dot" style="background:#D80E9E"></span>JC</span>
    <span class="sub-ley"><span class="sub-ley-dot" style="background:#0070C0"></span>CA</span>
  </div>
</div>
<!-- Leyenda colores equipos — fina, integrada -->
<div id="leyenda-strip">
  <div class="ley2"><span class="ley2-dot" style="background:#003087"></span><span>CAS</span></div>
  <div class="ley2"><span class="ley2-dot" style="background:#7030A0"></span><span>RMC</span></div>
  <div class="ley2"><span class="ley2-dot" style="background:#FFC000"></span><span>JA</span></div>
  <div class="ley2"><span class="ley2-dot" style="background:#275317"></span><span>JB</span></div>
  <div class="ley2"><span class="ley2-dot" style="background:#D80E9E"></span><span>JC</span></div>
  <div class="ley2"><span class="ley2-dot" style="background:#0070C0"></span><span>CA</span></div>
</div>
<!-- Días de la semana -->
<div id="semana-nav">
...
<div id="cal-overlay">
  <div id="cal-box">
    ...
    <div id="cal-grid"></div>
    <div id="cal-footer">
      <button id="cal-cancel" onclick="cerrarCal()" style="background:none;border:none;color:rgba(255,255,255,.5);font-size:22px;line-height:1;cursor:pointer;padding:4px 10px;">✕</button>
...
<script src="js/campograma-constants.js"></script>
<script src="js/campograma-logic.js"></script>
<!-- ═══════════════════════════════
...
<footer class="app-footer-maestro">
  Cantera del Real Madrid CF · Campograma
</footer>
</div>
...
<script src="js/campograma-darkmode.js"></script>
