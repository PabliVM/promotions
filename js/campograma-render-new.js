...
// Sin esto, firebase.firestore() + db.settings() se llaman dos veces y Firestore
// lanza "Firestore has already been started..." — eso rompe TODA la inicialización.
if (window.__rmFirebaseInitLoaded) {
  console.warn('campograma-render-new.js (firebase init) ya estaba cargado — segunda ejecución ignorada.');
} else {
window.__rmFirebaseInitLoaded = true;
...
} // cierre del guard __rmFirebaseInitLoaded
