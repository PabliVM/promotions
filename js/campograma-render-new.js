  ...
  btnCopiar.onclick = (e) => {
    ...
    zonas.forEach(({key, label}) => {
      ...
      jugsOrdenados.forEach(n => {
        ...
        const linea = '  - ' + (key === 'campo' && esExterno ? '_' + contenido + '_' : contenido);
        texto += linea + '\n';
      });
    });
